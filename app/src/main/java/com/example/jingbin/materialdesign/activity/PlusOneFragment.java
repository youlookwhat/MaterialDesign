...
public class PlusOneFragment extends Fragment {
    ...
    private final String PLUS_ONE_URL = "https://github.com/youlookwhat";
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        mPlusOneButton.setAnnotation(PlusOneButton.ANNOTATION_BUBBLE);
//        mPlusOneButton.setAnnotation(PlusOneButton.SIZE_MEDIUM);
        mPlusOneButton.setSize(PlusOneButton.SIZE_MEDIUM);

        mPlusOneButton.setOnPlusOneClickListener(new PlusOneButton.OnPlusOneClickListener() {
            @Override
            public void onPlusOneClick(Intent intent) {
                onButtonPressed(Uri.parse(PLUS_ONE_URL));
            }
        });
