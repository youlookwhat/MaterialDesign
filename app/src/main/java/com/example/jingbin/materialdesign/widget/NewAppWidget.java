package com.example.jingbin.materialdesign.widget;
...
import com.example.jingbin.materialdesign.MainActivity;
...
public class NewAppWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // 打开MainActivity
        views.setOnClickPendingIntent(R.id.appwidget_text, getOpenPendingIntent(context));
