package com.example.jingbin.materialdesign.list;
...
import com.example.jingbin.materialdesign.list.dummy.DummyContent;
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_list_content_right, parent, false);
...
//                }
//            };
//            holder.mView.setOutlineProvider(viewOutlineProvider);
...
//                        context.startActivity(intent);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                super(view);
                mView = view;
                mIdView = (ImageView) view.findViewById(R.id.image_id);
